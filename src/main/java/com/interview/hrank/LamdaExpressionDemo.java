...
public class LamdaExpressionDemo {
    ...
    static class MyMath {
        ...
        // a whole number greater than 1 that cannot be exactly divided by any whole number other than
    ...
    private static final List<String> lists2
            = Arrays.asList("3 344", "3 454", "2 68", "2 67", "1 12", "1 3");
