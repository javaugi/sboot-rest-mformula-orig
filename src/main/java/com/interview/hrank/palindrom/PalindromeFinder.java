...
public class PalindromeFinder {
     ...
     * replacing characters using other strings in the array
     */
    ...
    /**
     * Alternative approach: Check if characters can be rearranged to form
     * palindrome
     */
    ...
    /**
     * Most accurate approach: Try to form palindrome by checking character
     * availability
     */
    ...
    private static boolean canFormPalindromeWithReplacements(Map<Character, Integer> strFreq,
        ...
        for (Map.Entry<Character, Integer> entry : strFreq.entrySet()) {
            ...
            if (available < required) {
                ...
                // So if this character has odd requirement, we need to handle it carefully
                if (required % 2 == 1) {
                    oddCount++;
                    if (oddCount > 1) {
                        return false;
     ...
     * allows for at most one character with odd frequency
     */
