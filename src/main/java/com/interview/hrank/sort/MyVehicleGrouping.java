...
public class MyVehicleGrouping {
	...
	public static Integer[] countMakeModels(List<Vehicle> list) {
		...
		Map<String, List<Vehicle>> gList = list.stream()
			.parallel()
	...
	public static List<Vehicle> getVehicles() {
		return List.of(Vehicle.builder().make("Ford").model("F1").build(),
				Vehicle.builder().make("Ford").model("F2").build(), Vehicle.builder().make("Ford").model("F3").build(),
				Vehicle.builder().make("Ford").model("F4").build(), Vehicle.builder().make("GM").model("G1").build(),
				Vehicle.builder().make("GM").model("G2").build(), Vehicle.builder().make("GM").model("G3").build());
	}
