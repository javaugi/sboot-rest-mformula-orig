...
public class Code1WarmUpArrayManipulation {
	 ...
	 * 
	 * 
	 * Key Points: Single-pass O(N) time, O(1) space. Handles duplicates and edge cases
	...
	private void testStringListManipulation() {
		...
		List<String> filtered = myList.stream().filter(name -> !"Smith".equals(name)).collect(Collectors.toList());
	...
	private void testObjListManipulation() {
		List<Person> myList = new ArrayList(List.of(new Person("Smith", "John", 40),
				new Person("Mannone", "Shannon", 40), new Person("Thurn", "Anita", 45),
				new Person("Smith", "Kevin", 43), new Person("Peterson", "Gary", 60)));
		...
		myList = List.of(new Person("Smith", "John", 40), new Person("Mannone", "Shannon", 40),
				new Person("Thurn", "Anita", 45), new Person("Smith", "Kevin", 43), new Person("Peterson", "Gary", 60));
		filtered = myList.stream().filter(person -> !"Smith".equals(person.getLastName())).collect(Collectors.toList());
		System.out.println("2. filtered list " + filtered);

		myList = Arrays.asList(new Person("Smith", "John", 40), new Person("Mannone", "Shannon", 40),
				new Person("Thurn", "Anita", 45), new Person("Smith", "Kevin", 43), new Person("Peterson", "Gary", 60));
		filtered = myList.stream().filter(person -> !"Smith".equals(person.getLastName())).collect(Collectors.toList());
		System.out.println("3. filtered list " + filtered);
	}
	...
	private void testPerson2Manipulation() {
		...
		System.out.println("Person2 2 testPerson2Manipulation sorted : \n" + people);
		people.sort(Collections.reverseOrder());
		System.out.println("Person2 3 testPerson2Manipulation reverse sort : \n" + people);
		Collections.sort(people, Comparator.comparing(Person2::getLastName));
		System.out.println("Person2 4 testPerson2Manipulation srt by lastName: \n" + people);
		Collections.sort(people, Comparator.comparingInt(Person2::getAge));
	...
	private List<Person> createPersons() {
		return new ArrayList(List.of(new Person("Smith", "John", 40), new Person("Mannone", "Shannon", 40),
				new Person("Thurn", "Anita", 45), new Person("Smith", "Kevin", 43),
				new Person("Peterson", "Gary", 60)));
	}

	private List<Person2> createPersons2() {
		return new ArrayList(List.of(new Person2("Smith", "John", 40), new Person2("Mannone", "Shannon", 40),
				new Person2("Thurn", "Anita", 45), new Person2("Smith", "Kevin", 43),
