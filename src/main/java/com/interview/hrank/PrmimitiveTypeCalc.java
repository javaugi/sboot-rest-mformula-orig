...
public class PrmimitiveTypeCalc {
	...
	public static void main(String[] args) {
		/*
		 * Byte: -128 to 127 Short: -32768 to 32767 Int: -2147483648 to 2147483647 Long:
...
/*
 * Key Points: Wrapper Classes contain these values as constants: Byte.MIN_VALUE/MAX_VALUE
 * Short.MIN_VALUE/MAX_VALUE Integer.MIN_VALUE/MAX_VALUE Long.MIN_VALUE/MAX_VALUE
 * 
 * Pattern: For an N-bit signed integer type: Minimum = -2^(N-1) Maximum = 2^(N-1) - 1
 * Unsigned Types (Java 8+): int unsignedMax = Integer.parseUnsignedInt("4294967295");
 * 
