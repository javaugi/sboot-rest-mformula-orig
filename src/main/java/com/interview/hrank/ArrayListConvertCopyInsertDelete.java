...
public class ArrayListConvertCopyInsertDelete {
	...
	private static void test2() {
		...
		System.out.println("Oroginal array=" + Arrays.toString(intArr)); // [12, 0, 1, 78,
																			// 12]
		intArr = insertIntoIntArrUsingList(intArr, 5, 23);
		System.out.println("After insert 23 at 5 array=" + Arrays.toString(intArr)); // [12,
																						// 0,
																						// 1,
																						// 78,
																						// 12,
		...
		System.out.println("After delete at 0=" + Arrays.toString(intArr)); // [0, 1, 78,
																			// 12, 23]
	}
	...
	public static List<Integer> inputlineToIntegerList(String inputLine) {
		return Arrays.stream(inputLine.split("\\s+")).map(Integer::parseInt).collect(Collectors.toList());
	}
