...
public class ClassInheritance {
	...
	public static void main(String[] args) {
		...
		System.out.print(adderMultiple.add(10, 25, 3) + " ");
		System.out.print(adderMultiple.add(10, 10, 10));
	}

	/*
	 * But the first solution matches the exact problem description which mentions
	 * "takes 2 integers as parameters". The sample output showing three numbers (42, 13,
	 * 20) appears to be from multiple calls to the add method rather than a single call
...
/*
 * Key Points: Arithmetic Class: Adder Class: Inherits from Arithmetic using extends
 * keyword Automatically gets the add method from its superclass Doesn't need any
 * additional implementation since we're not modifying the behavior Solution Class:
 * Demonstrates the inheritance relationship Shows that Adder can use the add method from
 * Arithmetic Output matches the sample requirements: My superclass is: Arithmetic 42 13
 * 20
 */
