...
public class OpenCsvNpiValidation {
    ...
    private static final List<String> VALID_NPI_NOT_IN_REGISTRY
            = Arrays.asList(new String[]{"1999999984", "1999999992", "1999999976"});
    private static final List<String> DEACTIVATED_NPI_VALUES
            = Arrays.asList(
                    new String[]{
                        "1063810489",
                        "1073806253",
    ...
    // {"Errors": [{"field": "number", "number": "15", "description": "CMS deactivated NPI 1669463816.
    // The provider can no longer use this NPI. Our public registry does not display provider
            ...
            if (HttpStatus.SC_OK == response.getStatusLine().getStatusCode()) {
                ...
                if (returnValue.contains("result_count")) {
                    ...
                    if (returnValue.contains("Errors")) {
                        ...
                        writeMessage(
                                writer, String.format(MSG_INVALID_NPI_ERROR, npiEntry, jsonValue.get("Errors")));
                    } else {
