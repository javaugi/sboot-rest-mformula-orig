...
public class DateTimeManipulationDemo {
	...
	public static int randomInt20To30() {
		...
		int bound = 100;
		int randomIntBounded = (int) (Math.random() * bound); // Gets a random integer
																// from 0 to 99

		// To get a random integer within a specific range (e.g., between min and max
		// inclusive)
		int min = 20;
		int max = 30;
		int randomIntInRange = (int) (Math.random() * (max - min + 1)) + min; // Gets a
																				// random
																				// integer
																				// from 10
																				// to 20
	...
	public static int randomInt10To20() {
		...
		int min = 10;
		int max = 20;
		int randomIntInRange = random.nextInt(max - min + 1) + min; // Gets a random
																	// integer from 10 to
																	// 20
		return randomIntInRange;
	}
	...
	public class Solution {
		...
		/*
		 * public static void main(String[] args) throws IOException {
		 * //dateConsoleInput(); demoWithDates(); } //
		 */
	...
	class Result {
		...
		public static String findDay(int month, int day, int year) {
			...
			// "Wednesday", "Thursday",
			// "Friday", "Saturday") ;
			// String[] daysArr = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday",
			// "Friday",
			// "Saturday"};
