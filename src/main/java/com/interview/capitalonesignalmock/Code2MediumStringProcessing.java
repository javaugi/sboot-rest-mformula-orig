...
public class Code2MediumStringProcessing {
  ...
  O(N) time, O(1) space (since map size ≤ 3).
    ...
    public static void longestSubstringWithAtLeastTwoDistinctCharsMy(String s) {
        ...
        /*
    In summary:
        ASCII value: Obtain by casting a char to int. This gives you the character's numerical representation in the ASCII/Unicode table.
        Numerical value (for digits): Obtain by subtracting the ASCII value of '0' from the char's ASCII value. This gives you the
            actual integer value represented by the digit character.
         */

 /*
    Key Points Summary:
        1. Java char is a 16-bit unsigned integer (0-65,535)
        2. ASCII values range from 0-127
        3. Type casting: (int)char gets ASCII value, (char)int gets character
        4. Character arithmetic: chars can be used in mathematical operations
        5. Digit conversion: charDigit - '0' converts digit characters to integers
        6. Case conversion: Add/subtract 32 for ASCII case changes
        7. Unicode support: Java supports international characters beyond ASCII
         */
        for (char c : s.toCharArray()) {
            ...
            // Character.getNumericValue() returns the numeric value that the character represents in its
        ...
        System.out.println(
                "Numeric value (as a base 16? digit): " + Character.getNumericValue(ch1)); // 10
        ...
        System.out.println(
                "Numeric value (as a base 16? digit): " + Character.getNumericValue(ch)); // 10
        ...
        System.out.println(
                "Numeric value (as a base 16? digit): " + Character.getNumericValue(ch2)); // 10
