...
public class CoinChangeProblemSolMinimumCoins {
    ...
    public static void main(String[] args) {
        ...
        int amount = 595;
        log.info("\n min {} of coins needed to make {} \n from the coin collections {}", main.coinChange(coins, amount), amount, Arrays.toString(coins));
    }
    ...
    */
    public int coinChange(int[] coins, int amount) {
        ...
        //Assigns the specified (amount + 1) int value to each element of the specified dp array of ints.
