...
public class DecodeWaysStringToNumbers {
	...
	// Problem: Count how many ways a digit string can be decoded to letters (A=1, B=2,...
	// Z=26).
	/*
	 * Key Insight: Works backwards to avoid leading zero issues Checks both single-digit
	 * and two-digit possibilities Time: O(n), Space: O(n) (can be O(1) with variable
	 * optimization)
	 */
