...
public class AutonomousVehicleSensorCalibration {
    ...
    public int minCalibrationTime(int[][] tasks, int[] technicianTimes) {
        ...
        Arrays.sort(technicianTimes);  // Ascending order for Greedy Assignment: Pair longest tasks with fastest technicians:
        ...
        for (int i = 0; i < tasks.length; i++) {
            ...
            log.info("looping \t i={}, \t tt={}, \t taskTime={}, \t maxTime={} \t tasks[i][1]={}", i, tt, taskTime, maxTime, tasks[i][1]);
        }
        return maxTime;
    }
