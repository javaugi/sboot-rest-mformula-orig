...
public class EditDistanceStringConversion {
	...
	// Problem: Find minimum operations (insert, delete, replace) to convert string A to
	// B.
	/*
	 * Key Insight: DP table compares all prefixes of both strings Diagonal moves
	 * represent matches or substitutions Time/Space: O(m*n)
	 */
