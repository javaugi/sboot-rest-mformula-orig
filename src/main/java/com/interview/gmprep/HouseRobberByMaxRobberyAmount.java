...
public class HouseRobberByMaxRobberyAmount {
	...
	/*
	 * Problem: Maximize robbery amount without alerting police by robbing adjacent
	 * houses. Key Insight: Similar to assembly line problem with two states (rob/skip)
	 * Maintains only previous two states for optimization Time: O(n), Space: O(1)
	 */
