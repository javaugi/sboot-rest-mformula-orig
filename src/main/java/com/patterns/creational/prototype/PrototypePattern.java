 ...
 * the object, returns its clone on next request and update the database as and when
 ...
 *
 * <p>
 * Creating an object is an expensive operation and it would be more efficient to copy an
 * object.
 *
 * <p>
 ...
 *
 * <p>
 * The pattern is used by the Clonable interface in Java. Cloneable is implemented as a
 * marker interface to show what objects can be cloned, as Object already defined a
 * protected clone() method. Client can override, or call the superclass implementation,
 * of this clone method to do the copy.
 *
 * @author david
 * @version $LastChangedRevision $LastChangedDate Last Modified Author: $LastChangedBy
 */
/*
 * Step 1 Create an abstract class implementing Clonable interface. Step 2 Create concrete
 * classes extending the above class. Step 3 Create a class to get concrete classes from
 * database and store them in a Hashtable. Step 4 PrototypePattern uses ShapeCache class
