 ...
 */
/*
 * Abstract Factory Design Pattern Benefits Abstract Factory design pattern provides
 * approach to code for interface rather than implementation. Abstract Factory pattern is
 * “factory of factories” and can be easily extended to accommodate more products, for
 * example we can add another sub-class Laptop and a factory LaptopFactory. Abstract
 * Factory pattern is robust and avoid conditional logic of Factory pattern.
 * 
...
public class AbstractFactoryPattern {
	...
	public static void main(String[] args) {
		...
		// Objects.
		// Step 4 Create Factory classes extending AbstractFactory to generate object of
		// concrete class
		...
		// information
		// such as Shape
		// Step 6 Use the FactoryProducer to get AbstractFactory in order to get factories
		// of concrete
		// classes by
