 ...
 * implementation.It is a structural design pattern. There are 2 parts in Bridge design
 * pattern :
 *
 * <p>
 * 1. Abstraction
 ...
 */
/*
 * Step 1 Create bridge implementer interface. Step 2 Create concrete bridge implementer
 * classes implementing the DrawAPI interface. Step 3 Create an abstract class Shape using
 * the DrawAPI interface. Step 4 Create concrete class implementing the Shape interface.
 * 
 * We have a DrawApiBridge interface which is acting as a bridge implementer and concrete
 * classes RedCircle, GreenCircle implementing the DrawApiBridge interface. Shape is an
 * abstract class and will use object of DrawAPI.
 * 
