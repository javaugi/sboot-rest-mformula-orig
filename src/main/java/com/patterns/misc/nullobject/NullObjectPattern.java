 ...
 *
 * <p>
 * In Null Object pattern, we create an abstract class specifying various operations to be
 * done, concrete classes extending this class and a null object class providing do
 * nothing implemention of this class and will be used seemlessly where we need to check
 * null value.
 *
 * @author david
