 ...
 *
 * <p>
 * “An object that contains a symbol, name or key that represents a list of commands,
 * actions or keystrokes”. This is the definition of a macro, one that should be familiar
 * to any computer user. From this idea the Command design pattern was given birth. The
 * Macro represents, at some extent, a command that is built from the reunion of a set of
 ...
 *
 * <p>
 * - ConcreteCommand - extends the Command interface, implementing the Execute method by
 * invoking the corresponding operations on Receiver. It defines a link between the
 ...
 * and the ConcreteCommand that is in charge of the requested command, sending its result
 * to the Receiver.
 *
 * @author david
