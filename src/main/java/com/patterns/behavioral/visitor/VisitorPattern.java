 ...
 * object has to accept the visitor object so that visitor object handles the operation on
 * the element object. Visitor pattern is used when we have to perform an operation on a
 * group of similar kind of Objects. With the help of visitor pattern, we can move the
 ...
 * paid. Now we can have the calculation logic in item classes or we can move out this
 * logic to another class using visitor pattern. Let’s implement this in our example of
 * visitor pattern.
 *
 * @author david
