...
public class FindMaxFromTwoNumbers {
	...
	public static int getMax(int a, int b) {
		...
		/*
		 * We want to define a value k which is 1 if a > b and 0 if a < b. (if a = b, it
		 * doesn't matter what value k is)
		 */
		int use_sign_of_a = sa ^ sb; // If a and b have different signs, then k = sign(a)
		int use_sign_of_c = flip(sa ^ sb); // If a and b have the same sign, then k =
											// sign(a - b)
