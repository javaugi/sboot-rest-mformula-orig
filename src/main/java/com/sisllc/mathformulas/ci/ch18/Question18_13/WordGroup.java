...
public class WordGroup {
	...
	public static WordGroup[] createWordGroups(String[] list) {
		 ...
		 * length.groupList[i] will contain a list of words, each of length (i+1).
		 */
		groupList = new WordGroup[maxWordLength];
		for (int i = 0; i < list.length; i++) {
			/*
			 * We do wordLength - 1 instead of just wordLength since this is used as an
			 * index and no words are of length 0
			 */
