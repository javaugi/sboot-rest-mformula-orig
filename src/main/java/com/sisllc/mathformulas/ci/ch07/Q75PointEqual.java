...
public class Q75PointEqual {
	...
	public static void main(String[] args) {
		/*
		 * For an easy way to test these, open up Square Cut Tester.xlsx in the Chapter 7,
		 * Problem 5 folder. Copy and paste the exact output from below into the file
		 * (including all tabs).
		 */
		doTests();
	}
