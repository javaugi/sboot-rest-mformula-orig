...
public class Q45CreateBST2 {
	...
	public static boolean checkBSTAlternate(TreeNode n, D45IntWrapper min, D45IntWrapper max) {
		/*
		 * An alternate, less clean approach. This is not provided in the book, but is
		 * used to test the other method.
		 */
		if (n.left == null) {
			min.data = n.data;
		}
	...
	public static void main(String[] args) {
		...
		/*
		 * More elaborate test -- creates 100 trees (some BST, some not) and compares the
		 * outputs of various methods.
		 */
		/*
		 * for (int i = 0; i < 100; i++) { TreeNode head = createTestTree();
		 * 
		 * // Compare results boolean isBst1 = checkBST(head); boolean isBst2 =
		 * checkBSTAlternate(head);
		 * 
		 * if (isBst1 != isBst2) {
		 * System.out.println("*********************** ERROR *******************");
		 * head.print(); break; } else { System.out.println(isBst1 + " | " + isBst2);
		 * head.print(); } }
		 */
	}
