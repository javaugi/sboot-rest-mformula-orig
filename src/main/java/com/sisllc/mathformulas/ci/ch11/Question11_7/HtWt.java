...
public class HtWt implements Comparable {
	...
	/*
	 * Returns true if this should be lined up before other. Note that it's possible that
	 * this.isBefore(other) and other.isBefore(this) are both false. This is different
	 * from the compareTo method, where if a < b then b > a.
	 */
