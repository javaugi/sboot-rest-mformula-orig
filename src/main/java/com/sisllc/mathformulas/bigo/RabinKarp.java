...
public class RabinKarp {
	...
	/**
	 * Takes a pattern string and an input string as command-line arguments; searches for
	 * the pattern string in the text string; and prints the first occurrence of the
	 * pattern string in the text string.
