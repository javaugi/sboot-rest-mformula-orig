 ...
 * <p>
 * Q: There are stairs, each time one can clime 1 or 2, how many different ways to clibe
 * the stairs
 * <p>
 * Step 1. Finding the relationships before n and n - 1. To get n there are two ways, one
 * 1-stair from n-1 or 2-stairs from n-2. If the f(n) is the number of ways to clime to n
 ...
 * f(0) = 0; f(1) = 1
 * <p>
 * Dynamic programing - is a technique for solving the problems with the following
 * properties
 * <p>
 ...
 * <p>
 * 3. The solutions to small instances is stored in a table, so that each smaller instance
 * is solved only once
 * <p>
