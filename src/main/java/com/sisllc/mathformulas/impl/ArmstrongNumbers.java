...
/**
 * @author david An Armstrong number is an n-digit number that is equal to the sum of the
 * nth powers of its digits. For example: 371 = 33 +73 +13 9474 = 94 + 44 +74 + 44
 */
