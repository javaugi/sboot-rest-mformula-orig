...
/**
 * Euclidean Algorithm The Euclidean algorithm is a way to find the greatest common
 * divisor of two positive integers.
 *
 * <p>
 * Program to find GCD or HCF of two numbers GCD (Greatest Common Divisor) or HCF (Highest
 * Common Factor) of two numbers is the largest number that divides both of them.
 *
 * <p>
...
public class EuclideanAlgorithm {
	...
	// If we subtract smaller number from larger(we reduce larger number), GCD doesn’t
	// change.
	...
	// Now instead of subtraction, if we divide smaller number, the algorithm stops when
	// we find
	// remainder 0.
