...
/**
 * Sieve Of Eratosthenes This java example shows the calculation of prime numbers with the
 ...
 * prime, starting with the first prime number, 2. The multiples of a given prime are
 * generated as a sequence of numbers starting from that prime, with constant difference
 * between them that is equal to that prime.[1] This is the sieve's key distinction from
 * using trial division to sequentially test each candidate number for divisibility by
 * each prime.[2]
 *
 * @author david
 */
