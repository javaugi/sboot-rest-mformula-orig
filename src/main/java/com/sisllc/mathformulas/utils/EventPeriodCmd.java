...
public class EventPeriodCmd {
	...
	public EventPeriodCmd(int intervalByWeeks, LocalDate initialStartDate, LocalDate targetPeriodStart,
			LocalDate targetPeriodEnd) {
		this(intervalByWeeks, initialStartDate, targetPeriodStart, targetPeriodEnd, null);
	}

	public EventPeriodCmd(int intervalByWeeks, LocalDate initialStartDate, LocalDate targetPeriodStart,
			LocalDate targetPeriodEnd, LocalDate targetPeriodUntil) {
	...
	public EventPeriodCmd(int intervalByWeeks, Date initialStartDate, Date targetPeriodStart, Date targetPeriodEnd,
			Date targetPeriodUntil) {
		this(intervalByWeeks, userLocalDateOfDate(initialStartDate), userLocalDateOfDate(targetPeriodStart),
				userLocalDateOfDate(targetPeriodEnd), userLocalDateOfDate(targetPeriodUntil));
	}
