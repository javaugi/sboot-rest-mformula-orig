...
public class ExternalServiceCaller {
    ...
    public ExternalServiceCaller() {
        ...
        retry
                ...
                .onRetry(
                        event
                        -> System.out.println("Retrying call: " + event.getNumberOfRetryAttempts() + " time"));
    }
 ...
 /*
  ...
  // */
    ...
    // */
        ...
        Function0<String> call
                = (Function0<String>) CircuitBreaker.decorateCheckedFunction(
                        circuitBreaker,
                        (String) -> {
                            System.out.println("Attempting to call external service...");
                            // Simulate external service call that might fail
        ...
        return Try.of(call0)
                .recover(
                        throwable -> {
                            System.err.println(
                                    "External service call failed after retries and circuit breaker intervention: "
