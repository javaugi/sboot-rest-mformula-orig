...
public class AppController {
    ...
    private static final String NO_PROFILE_ERROR
            = "No mode was provided in active profile set. Expected one of the following: mongo, jackrabbit, or file";
    private static final String MISSING_OPERATION_MODE_PROFILE
            = "Mode active profile not supported. Expected one of the following: mongo, jackrabbit, or file. Found: {}";
    private static final String CANT_SLEEP_FOR_SOME_REASON = "Can't sleep for some reason.";
    private static final String CIM_FILE_SERVICE_APPLICATION_INITILIZED
            = "CimFileService application initilized";
