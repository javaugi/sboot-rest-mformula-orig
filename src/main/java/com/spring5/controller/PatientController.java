...
public class PatientController {
                        ...
                        .map(
                                ...
                                -> new PatientModel(patient)
                                        ...
                                        .add(
                                                linkTo(
                                                        methodOn(PatientController.class)
                                                                .getPatientAssessments(patient.getId()))
                                                        .withRel("assessments")))
    ...
    public ResponseEntity<PatientModel> getPatientById(@PathVariable Long id) {
        ...
        PatientModel patientModel
                = new PatientModel(patient)
                        ...
                        .add(
                                linkTo(methodOn(PatientController.class).getPatientAssessments(id))
                                        .withRel("assessments"))
                        .add(
                                linkTo(methodOn(PatientController.class).updatePatient(id, null))
                                        .withRel("update"));
    ...
    public ResponseEntity<PatientModel> createPatient(@RequestBody Patient patient) {
        ...
        PatientModel patientModel
                = new PatientModel(createdPatient)
                        .add(
                                linkTo(methodOn(PatientController.class).getPatientById(createdPatient.getId()))
                                        .withSelfRel())
                        .add(linkTo(methodOn(PatientController.class).getAllPatients()).withRel("patients"))
                        .add(
                                linkTo(
                                        methodOn(PatientController.class)
                                                .getPatientAssessments(createdPatient.getId()))
                                        .withRel("assessments"));
    ...
    public CollectionModel<AssessmentModel> getPatientAssessments(@PathVariable Long patientId) {
        ...
        List<Assessment> assessments
                = patientService.findAssessmentsByPatientId(patientId, assessmentService);
                                    ...
                                    model
                                            .add(
                                                    linkTo(
                                                            ...
                                                            .withSelfRel())
                                            .add(
                                                    linkTo(methodOn(PatientController.class).getPatientById(patientId))
                                                            .withRel("patient"))
                                            .add(
                                                    linkTo(
                                                            methodOn(AssessmentController.class)
        ...
        return CollectionModel.of(assessmentModels)
                .add(
                        linkTo(methodOn(PatientController.class).getPatientAssessments(patientId))
                                .withSelfRel())
                .add(
                        linkTo(methodOn(PatientController.class).getPatientById(patientId)).withRel("patient"));
    }
}
