...
@Tag(name = "Project Management",
		description = "APIs for managing development projects within the Order Management System")
public class ProjectController {
	...
	@ApiResponse( // @ApiResponse describes a possible response
			responseCode = "200", description = "Successfully retrieved list of projects",
	...
	@ApiResponses(value = { // Use @ApiResponses for multiple possible responses
			...
			@ApiResponse(responseCode = "404", description = "Project not found", content = @Content) // No
																										// content
																										// schema
																										// for
																										// 404
	})
	public ResponseEntity<ProjectDTO> getProjectById(@Parameter( // @Parameter describes a
																	// method parameter
			description = "ID of the project to be retrieved", required = true,
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Project updated successfully"),
	...
	public ResponseEntity<Void> deleteProject(@Parameter(description = "ID of the project to be deleted",
			required = true, example = "123") @PathVariable Long id) {
