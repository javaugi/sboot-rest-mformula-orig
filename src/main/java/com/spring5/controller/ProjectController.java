...
public class ProjectController {
    ...
    @ApiResponses(
            value = { // Use @ApiResponses for multiple possible responses
                ...
                @ApiResponse(
                        ...
                        content = @Content) // No content schema for 404
            })
    ...
    public ResponseEntity<ProjectDTO> updateProject(
            @Parameter(description = "ID of the project to be updated", required = true, example = "123")
            @PathVariable Long id,
    ...
    public ResponseEntity<Void> deleteProject(
            @Parameter(description = "ID of the project to be deleted", required = true, example = "123")
            @PathVariable Long id) {
