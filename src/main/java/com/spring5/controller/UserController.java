...
public class UserController {
  ...
  // */
    ...
    public String listUsers(
            Locale locale, Model model, HttpServletRequest request, ModelMap modelMap) {
    ...
    private List<User> createUsers() {
        ...
        for (int i = 0; i < 100; i++) {
            user = new User();
            user.setUsername(
                    F_N_LIST.get(rand.nextInt(F_N_LIST.size()))
                    + " "
    ...
    static final String[] FIRST_NAMES = {
        "Alex", "Arby", "Allen", "Abbey", "Ashley", "Ben", "Bill", "Carol", "Dan", "Don", "Doug",
        "Ernie", "Gary", "Jax", "Jon", "Jeff", "Jessica", "Kevin", "Shannon"
    };
    static final String[] LAST_NAMES = {
        "Alton", "Aleon", "Atux", "Lee", "Swift", "Liu", "Alexon", "Alatian", "Smith", "Smita", "Will",
        "Wall", "Zina"
    };
