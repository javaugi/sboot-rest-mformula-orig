...
public class UserController {
	...
	/*
	 * @GetMapping("/") public String userForm(Locale locale, Model model) {
	 * model.addAttribute("users", userService.findAll()); return "editUsers"; } //
	 */
    ...
    private List<User> createUsers() {
		...
		for (int i = 0; i < 100; i++) {
			user = new User();
			user.setUsername(
					F_N_LIST.get(rand.nextInt(F_N_LIST.size())) + " " + L_N_LIST.get(rand.nextInt(L_N_LIST.size())));
	...
	static final String[] FIRST_NAMES = { "Alex", "Arby", "Allen", "Abbey", "Ashley", "Ben", "Bill", "Carol", "Dan",
			"Don", "Doug", "Ernie", "Gary", "Jax", "Jon", "Jeff", "Jessica", "Kevin", "Shannon" };
	static final String[] LAST_NAMES = { "Alton", "Aleon", "Atux", "Lee", "Swift", "Liu", "Alexon", "Alatian", "Smith",
			"Smita", "Will", "Wall", "Zina" };
	static final String[] EMAILS = { "aaa@ciminc.com", "a12@ciminc.com", "a2a@ciminc.com", "alibaba@ciminc.com",
			"alab@ciminc.com", "alex@ciminc.com", "arby@ciminc.com", "Allen@ciminc.com", "Abbey@ciminc.com",
			"Ashley@ciminc.com", "Ben@ciminc.com", "Bill@ciminc.com", "Carol@ciminc.com", "Dan@ciminc.com",
			"Don@ciminc.com", "Doug@ciminc.com", "Ernie@ciminc.com", "Gary@ciminc.com", "Jax@ciminc.com",
			"Jon@ciminc.com", "Jeff@ciminc.com", "Jessica@ciminc.com", "Kevin@ciminc.com", "Shannon@ciminc.com" };
