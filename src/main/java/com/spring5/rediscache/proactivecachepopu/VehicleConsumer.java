...
public class VehicleConsumer {
    ...
    public VehicleConsumer(
            String bootstrapServers, String schemaRegistryUrl, String topicName, String groupId) {
        ...
        // This allows the deserializer to use the consumer's schema when the producer's schema is
        // newer.
    ...
    public void startConsuming() {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, GenericRecord> record : records) {
                ...
                // but exists in your consumer's reader schema (because of a default value or being
                // optional),
                ...
                System.out.printf(
                        "Received event: VIN=%s, Make=%s, Model=%s, Year=%d", vin, make, model, year);
                if (color != null) {
    ...
    public static void main(String[] args) {
        ...
        VehicleConsumer consumer
                = new VehicleConsumer(bootstrapServers, schemaRegistryUrl, topic, groupId);
        try {
