...
public class ProductCacheUpdateListener {
	...
	/*
	 * Strategies for Regional Caching (Spring + Redis or Caffeine) 🧩 1. Region as Part
	 * of the Cache Key This is the simplest and most scalable approach.
	 * 
	 * Example: String region = "US"; // or detect from user/session/header String
	 * cacheKey = "product:" + region + ":" + productId; All cache reads and writes are
	 * then scoped to that region.
	 * 
