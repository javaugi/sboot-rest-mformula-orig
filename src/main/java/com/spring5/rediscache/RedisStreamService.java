...
public class RedisStreamService {
    ...
    private final RedisTemplate<String, String> redisTemplate; // RedisTemplate for general ops
    private final StreamOperations<String, String, String> streamOperations; // Stream-specific operations
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Example with a basic RedisTemplate setup (replace with your actual Spring Boot config):
