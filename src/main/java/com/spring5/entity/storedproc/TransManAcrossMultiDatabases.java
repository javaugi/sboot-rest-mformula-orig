...
1. Spring Boot REST API with JPA
Question: Create a Spring Boot REST API for a book management system with CRUD operations.
...
Question: How would you secure this API with JWT authentication?
...
Database Stored Procedures Examples
PostgreSQL Stored Procedures
Question: Create a stored procedure to get books by author with pagination.
...
Question: Create a procedure to update book prices by percentage.
...
Question: Create a procedure to archive old books.
...
MongoDB Stored Procedures (Using JavaScript)
Question: Create a MongoDB stored JavaScript function to calculate and update book ratings.
...
Question: How would you handle transactions across multiple database operations?
...
Question: How would you optimize a slow-running query in a Spring Boot application?
...
Database Migration
Question: How would you handle database schema changes in a production environment?

java
// Using Flyway (in application.properties)
spring.flyway.locations=classpath:db/migration
spring.flyway.baseline-on-migrate=true

// Example migration file (V2__Add_author_column.sql)
...
Know how to analyze query performance (EXPLAIN in PostgreSQL, Execution Plan in SQL Server)
