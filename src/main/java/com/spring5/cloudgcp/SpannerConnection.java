...
public class SpannerConnection {
  ...
  4. Reading specific data using Keys.
    ...
    private static final String INSTANCE_ID
            = "your-spanner-instance-id"; // **REPLACE WITH YOUR INSTANCE ID**
    private static final String DATABASE_ID
            = "your-spanner-database-id"; // **REPLACE WITH YOUR DATABASE ID**
        ...
        try (ResultSet resultSet
                = dbClient
                        ...
                        .read(
                                "Singers", // Table name
                                KeySet.singleKey(
                                        Key.of(singerId)), // Key(s) to read. For multi-column primary keys, use
                                // Key.of(col1, col2, ...)
