...
/*
 * URI syntax Redis Standalone
 * 
 * redis :// [[username :] password@] host [:port][/database]
 * [?[timeout=timeout[d|h|m|s|ms|us|ns]] [&clientName=clientName]
 * [&libraryName=libraryName] [&libraryVersion=libraryVersion] ] Redis Standalone (SSL)
 * 
 * rediss :// [[username :] password@] host [: port][/database]
 * [?[timeout=timeout[d|h|m|s|ms|us|ns]] [&clientName=clientName]
 * [&libraryName=libraryName] [&libraryVersion=libraryVersion] ] Redis Standalone (Unix
 * Domain Sockets)
 * 
 * redis-socket :// [[username :] password@]path [?[timeout=timeout[d|h|m|s|ms|us|ns]]
 * [&database=database] [&clientName=clientName] [&libraryName=libraryName]
 * [&libraryVersion=libraryVersion] ] Redis Sentinel
 * 
 * redis-sentinel :// [[username :] password@] host1[:port1] [, host2[:port2]] [,
 * hostN[:portN]] [/database] [?[timeout=timeout[d|h|m|s|ms|us|ns]]
 * [&sentinelMasterId=sentinelMasterId] [&clientName=clientName]
