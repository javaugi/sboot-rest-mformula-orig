...
public class BatchFetchingEntityGraph {
    ...
    private void batchFetchProgrammaticaly() {
        ...
        List<Employee> employees = entityManager.createQuery(
            "SELECT e FROM Employee e WHERE e.department IS NOT NULL", Employee.class)
    ...
    private void staticEntityGraphDefinition(){
        ...
        //EntityGraph<Employee> graph = entityManager.createEntityGraph("employee.withDepartmentAndProfile");
        ...
        employees.forEach(emp -> {
            System.out.println(emp.getName() + 
                ...
                " has profile: " + emp.getProfile().getBio());
        });        
    ...
    private void dynamicEntityGraph() {
        ...
        // Use in query
        List<Employee> employees = entityManager.createQuery(
            "SELECT e FROM Employee e WHERE e.joinDate > :date", Employee.class)
