...
Complexity              Simpler application logic. The SDK handles the complex orchestration.	More complex application logic. Y
    ...
    //Mention of EventProcessorClient which handles load balancing and checkpointing across partitions and multiple consumers. This is crucial.
     ...
     */
    public EventHubProcessor(@Value("${eventhub.conn}") String conn,
        ...
        builder2.consumerGroup(EventHubClientBuilder.DEFAULT_CONSUMER_GROUP_NAME); // Or a custom consumer group name
