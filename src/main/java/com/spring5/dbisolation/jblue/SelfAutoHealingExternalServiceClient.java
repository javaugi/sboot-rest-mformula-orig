...
public class SelfAutoHealingExternalServiceClient {
	...
	/*
	 * see application.yml resilience4j.circuitbreaker: instances: externalService:
	 * registerHealthIndicator: true slidingWindowType: COUNT_BASED slidingWindowSize: 10
