...
public class EventProcessorClientExample {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		BlobContainerAsyncClient blobAsyncClient = new BlobContainerClientBuilder()
	...
	private static final Consumer<EventContext> PROCESS_EVENT = eventContext -> {
		EventData event = eventContext.getEventData();
		PartitionContext partition = eventContext.getPartitionContext();

		System.out.printf("Processing event from Partition %s: Seq %d, Body: %s%n", partition.getPartitionId(),
				event.getSequenceNumber(), event.getBodyAsString());
	...
	private static final Consumer<ErrorContext> PROCESS_ERROR = errorContext -> {
