...
public class GMCodility {
    ...
    private void testFib() {
        ...
        log.info(
                "1 Looping Done   for n {} current time {}     at cost {} \n values {}",
                n,
        ...
        log.info(
                "2 Looping Done   for n {} current time {}     at cost {} \n values {}",
                n,
                System.currentTimeMillis(),
                (System.currentTimeMillis() - timestamps),
                sb.toString());
        ...
        if (startDate != null) {
            if (endDate != null && startDate.isAfter(endDate)) {
                throw new ResponseStatusException(
                        HttpStatus.BAD_REQUEST, "Start Date cannot be after End Date");
            }
        }
 ...
 /*
    ...
    // what is the most efficient solution to find smallest positive integer from an integer that is
    ...
    private int[] twoSumToTarget(int[] nums, int target) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            if (numToIndex.containsKey(complement)) {
                log.info(
                        "Fopund {} from index {} value {} and index {} value {}",
                        target,
                        i,
                        nums[i],
                        numToIndex.get(complement),
                        complement);
