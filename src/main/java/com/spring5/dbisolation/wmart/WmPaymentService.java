...
public class WmPaymentService {
	...
	public WmPaymentService(ExternalCurrencyServiceClient currencyClient) {
	...
	// Fallback method
	private CompletableFuture<BigDecimal> getCachedConversionRate(String fromCurrency, String toCurrency,
