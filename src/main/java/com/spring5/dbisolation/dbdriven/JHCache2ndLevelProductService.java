...
public class JHCache2ndLevelProductService {
	...
	public void sequence1Cache2ndLevelEnable() {
		/*
		 * <!-- For Ehcache as second-level cache provider --> <dependency>
		 ...
		 * <artifactId>ehcache</artifactId> </dependency> Configure in
		 * application.properties:
		 * 
		 * properties # Enable second-level cache
		 * spring.jpa.properties.hibernate.cache.use_second_level_cache=true
		 * spring.jpa.properties.hibernate.cache.region.factory_class=org.hibernate.cache.
		 * ehcache.EhCacheRegionFactory
		 * 
		 * # Enable query cache spring.jpa.properties.hibernate.cache.use_query_cache=true
		 * 
		 * # Show SQL for demonstration spring.jpa.show-sql=true Create ehcache.xml in
		 * src/main/resources:
		 * 
		 ...
		 * 
		 * <cache name="com.example.model.Product" maxElementsInMemory="1000"
		 * eternal="false" timeToIdleSeconds="300" timeToLiveSeconds="600"/> </ehcache>
		 */
