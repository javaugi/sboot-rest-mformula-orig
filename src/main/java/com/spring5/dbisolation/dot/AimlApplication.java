...
public class AimlApplication {
    ...
    /**
     * This method is a CommandLineRunner that will run on application startup.
     * It's used here to pre-populate the H2 in-memory database with some sample
     * tasks. This is a great way to showcase Spring's dependency injection and
     * get some data for the frontend to display immediately.
     */
    @Bean
