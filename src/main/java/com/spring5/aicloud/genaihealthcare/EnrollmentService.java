...
public class EnrollmentService {
	...
	public EnrollmentResult enrollPatient(String patientId, String consentId, String email, boolean acceptMarketing,
			String freeText) {
		...
		Map<String, Double> derived = raiService.deriveScoresFromResponse(prompt, resp.text, resp.confidence,
				consentOk);
		String notes = "auto-derived scores";
		raiService.computeAndStore("LoyaltyEnrollment", resp.modelName, notes, derived.get("transparency"),
				derived.get("fairness"), derived.get("privacy"), derived.get("regulatory"));
