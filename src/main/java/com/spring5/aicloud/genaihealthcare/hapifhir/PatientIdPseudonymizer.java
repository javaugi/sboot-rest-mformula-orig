...
public class PatientIdPseudonymizer {
	 ...
	 * 3. Key Points
	 * 
	 * Per-Environment Key: For dev, test, prod, use different keys (rotate periodically).
	 * Store in Azure KeyVault, AWS Secrets Manager, or HashiCorp Vault.
	 * 
	 * HMAC-SHA256 ensures: Deterministic mapping → Same input → Same pseudonym
	 * Non-reversible outside your environment without the key Base64 URL-safe encoding →
	...
	public static void main(String[] args) {
		// Example: key should come from secure config (e.g., Spring Boot application.yml
		// or Azure
		// KeyVault)
