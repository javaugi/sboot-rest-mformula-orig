...
public interface TradeRepository extends JpaRepository<Trade, Long> {
    ...
    @Query(
            "SELECT t FROM Trade t JOIN FETCH t.userAccount ua JOIN FETCH ua.user u WHERE u.userEmail=(:userEmail)")
    ...
    @Query(
            "UPDATE UserAccount SET cashBalance = cashBalance + (:amount) WHERE account =(:userAccount)")
    void addMoneyByAccount(
            @Param("userAccount") String userAccount, @Param("amount") BigDecimal amount)
            throws Exception;
}
