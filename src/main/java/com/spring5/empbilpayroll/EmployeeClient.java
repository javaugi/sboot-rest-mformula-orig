...
public class EmployeeClient {
        ...
        for (String code: keySet) {
            ...
            while (i++ < n) {
                emp = create(lastNames.get(rand.nextInt(lastNames.size())),
                        ...
                        dept.getCode(), dept.getName(), salaries.get(rand.nextInt(salaries.size())));
                employees.add(emp);
            }
        }
        ...
        for (String code: keySet) {            
            ...
            while (i++ < n) {
                emp = create(lastNames.get(rand.nextInt(lastNames.size())),
                        firstNames.get(rand.nextInt(firstNames.size())),
                        middleInitial.get(rand.nextInt(middleInitial.size())),
                        code, deptMap.get(code), salaries.get(rand.nextInt(salaries.size())));
                employees.add(emp);
            }
        }
    ...
    public static Employee create(String lastName, String firstName, String middleInit, String deptCode, String departName, double salary) {
