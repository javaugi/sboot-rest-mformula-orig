...
public class MedicalDocumentDto {
	...
	@Schema(description = "Title of the document", example = "Medical Document Dashboard",
	...
	@Schema(description = "Timestamp when the medical document was created", example = "2024-10-27T10:30:00",
