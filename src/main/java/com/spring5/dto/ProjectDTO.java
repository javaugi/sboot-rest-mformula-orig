...
public class ProjectDTO {
	...
	@Schema(description = "Name of the project", example = "Enterprise Fulfillment Dashboard",
	...
	@Schema(description = "Timestamp when the project was created", example = "2024-10-27T10:30:00",
