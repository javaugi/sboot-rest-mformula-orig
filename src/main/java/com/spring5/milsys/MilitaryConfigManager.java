...
public class MilitaryConfigManager {
	...
	private static final String ENCRYPTION_KEY = "AES-256-Encryption-Key"; // In real
																			// system, use
																			// HSM
	...
	public MilitaryConfigManager() throws IOException {
		...
		if (!Files.exists(configPath)) {
			...
			Files.setPosixFilePermissions(configPath, Set.of(PosixFilePermission.OWNER_READ,
	...
	public String getConfig(String key) {
		...
		if (value == null) {
			// throw new DefenseConfigException("Missing required military configuration:
			// " + key);
		}
		return value;
	}
