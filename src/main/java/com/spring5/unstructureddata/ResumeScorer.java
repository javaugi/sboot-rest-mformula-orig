...
public class ResumeScorer {
	...
	private static final Map<String, Integer> SKILL_WEIGHTS = Map.of("Java", 10, "Python", 8, "AWS", 12, "Spring", 10);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Resume Score: " + calculateScore(resume)); // Output: 45
																		// (Java=10,
																		// Spring=10,
																		// 3y*5=15,
																		// Education=10)
