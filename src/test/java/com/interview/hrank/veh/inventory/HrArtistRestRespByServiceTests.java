...
public class HrArtistRestRespByServiceTests {

	private static final String BASE_REST_URI = "/v1rbsv/artists";

	private static final String BASE_REST_URI_W_ID = "/v1rbsv/artists/";
