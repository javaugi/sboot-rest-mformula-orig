 ...
 */
package com.interview.hrank.pact;
...
public class UserServiceProviderPactTest {
	...
	void usersWithStatusActiveExist() {
		...
		User user1 = User.builder().id(1L).name("John Doe").email("john.doe@example.com").status("ACTIVE").build();

		User user2 = User.builder().id(2L).name("Jane Smith").email("jane.smith@example.com").status("ACTIVE").build();
