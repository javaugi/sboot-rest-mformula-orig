...
public class LeastCostAssemblySolutionsTests {
    ...
    public void testLongestSubstring_Parameterized() {
        ...
        AssemblyLineParallelStationsWithFixedTransfer main = new AssemblyLineParallelStationsWithFixedTransfer();
        ...
        System.out.println("LeastCostAssemblySolutionsTests cost=" + totalCost + "-cost2=" + totalCost2);
